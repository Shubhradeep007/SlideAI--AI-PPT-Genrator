...
const firebaseConfig = {
  ...
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSGING_SENDER_ID,
...
export const GemeniAIModel = getGenerativeModel(ai, { model: "gemini-2.5-flash" });


// Create a `LiveGenerativeModel` instance with the flash-live model (only model that supports the Live API)
export const GeminiAiModel = getLiveGenerativeModel(ai, {
