  ...
  return (
     ...
     <BackgroundRippleEffect />
      <div className="mt-45 w-full">
        <TextAnimate animation="blurIn" as="h2" className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold md:text-4xl lg:text-7xl">
          From Idea to Presentation in 1 Click ⚡
        </TextAnimate>
        <div className="flex flex-col gap-2">
          <TextAnimate animation="blurIn" as="h2" className="relative z-10 mx-auto mt-4 max-w-xl text-center lg:text-xl">
            Generate Sleek, editable PPT's Powerd by AI.
          </TextAnimate>
          <TextAnimate animation="blurIn" as="h2" className="relative z-10 mx-auto max-w-xl text-center lg:text-xl">
