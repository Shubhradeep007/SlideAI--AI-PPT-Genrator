  ...
  return (
    <section className="relative p-10 py-16 overflow-hidden">
      ...
      <div className="pointer-events-none -z-10 absolute inset-0">
        <div className="absolute left-[-8%] top-10 w-80 h-80 rounded-full bg-gradient-to-br from-purple-300 via-pink-200 to-transparent blur-3xl opacity-40 dark:opacity-20"></div>
        <div className="absolute right-[-6%] top-1/3 w-96 h-96 rounded-full bg-gradient-to-tr from-blue-200 via-cyan-200 to-transparent blur-3xl opacity-30 dark:opacity-15"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8 items-center ml-20 w-full">
          ...
          <div className="lg:col-span-4 ml-50 md:col-span-4 flex flex-col gap-5">
            <TextAnimate
              animation="blurIn"
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8 items-center mt-1 mr-12">
          <div className="p-10 md:col-span-4 flex flex-col gap-3">
            <TextAnimate
              animation="blurIn"
              className="text-2xl md:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight"
            >
            ...
            <TextAnimate
              animation="blurIn"
              className="text-sm md:text-base text-gray-600 dark:text-gray-300 flex-wrap-reverse"
            >
