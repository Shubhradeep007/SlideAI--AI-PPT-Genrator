...
const Navbar = () => {
  ...
  useEffect(() => {
    // Allow navigation only after first UI paint
    const t = setTimeout(() => setIsFirstRender(false), 200);
          ...
          <div className="flex-1 px-4">
            <div className="hidden md:flex justify-center">
              <GooeyNav
                ...
                onActiveChange={(idx) => {
                  if (isFirstRender) return; // ✅ Prevent unwanted navigation during refresh
